jQuery( document ).ready(function($) {
    ...
    ancords.forEach( ele => {
        ele.addEventListener('click', () => {
            ...
            console.log('im currentpoint'+currentpoint);
    ...
    function setNumberToFirst(index){
        ...
        console.log(index);
        console.log(jQuery('.card').eq(index).find('.card-title').text());
    }
...
// });
    ...
    $('#video .vice-modernslider-item a').on('click',function(e){
        ...
        // &controls=0
        let yt = modernslider_item.find('.vice-modernslider-item__thumbnail a').data('yt') + '?autoplay=1&mute=1&showinfo=0';
