...
// });
    ...
    $('#block-8').find('.wp-block-column').eq(0).append('<p><span class="icon-global"></span><a href="./zh-hant/index.html" data-type="URL" rel="noreferrer noopener">English</a></p>').find('p').css({
        'display':'flex',
        'flex-wrap':'wrap',
        'align-items': 'center',
